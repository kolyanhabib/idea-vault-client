...
const IdeaCard = ({ idea }) => {
  ...
  return (
    <div className="group overflow-hidden rounded-[30px] border border-slate-200 bg-white transition-all duration-500 hover:-translate-y-2 hover:border-violet-300 hover:shadow-[0_20px_60px_rgba(124,58,237,0.15)] dark:border-slate-800 dark:bg-slate-900 dark:hover:border-violet-500/40 dark:hover:shadow-[0_20px_60px_rgba(124,58,237,0.25)]">
      {/* IMAGE */}
        ...
        <div>
          ...
          <div className="mt-7 flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300">
            ...
            {/* BUDGET */}
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300">
                <Wallet size={17} />
              </div>
          ...
          <div className="mt-7 flex items-center gap-3 border-t border-slate-200 pt-5 dark:border-slate-800">
            <div className="relative h-12 w-12 overflow-hidden rounded-full ring-2 ring-violet-100 dark:ring-violet-500/30">
              <Image
                src={
                  profile ||
